...
@section('content')
    <x-tabler::cards.card>
        <x-tabler::cards.body>
            <section id="content">
                <h2 class="sticky-xl-top fw-bold pt-xl-5 pb-xl-3 pb-2 pt-3">Contents</h2>
                            ...
                            <figure class="figure">
                                <svg class="bd-placeholder-img figure-img img-fluid rounded" width="400"
                                    ...
                                    <rect width="100%" height="100%" fill="#868e96" /><text x="50%" y="50%"
                                        fill="#dee2e6" dy=".3em">400x300</text>
                                </svg>
            ...
            <section id="forms">
                <h2 class="sticky-xl-top fw-bold pt-xl-5 pb-xl-3 pb-2 pt-3">Forms</h2>
                        ...
                        <div class="bd-example">
                            <form>
                                <fieldset disabled aria-label="Disabled fieldset example">
                                    ...
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="disabledSwitchCheckChecked"
                                            checked disabled>
                                        <label class="form-check-label" for="disabledSwitchCheckChecked">Disabled checked
            ...
            <section id="components">
                <h2 class="sticky-xl-top fw-bold pt-xl-5 pb-xl-3 pb-2 pt-3">Components</h2>
                                            ...
                                            <div class="col-md-4">
                                                <svg class="bd-placeholder-img" width="100%" height="250"
                                                    ...
                                                    <rect width="100%" height="100%" fill="#868e96" /><text x="50%"
                                                        y="50%" fill="#dee2e6" dy=".3em">Image</text>
                                                </svg>
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item">
                                        <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800"
                                            ...
                                            focusable="false">
                                            <title>Placeholder</title>
                                            <rect width="100%" height="100%" fill="#666" /><text x="50%" y="50%"
                                    ...
                                    <div class="carousel-item">
                                        <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" width="800"
                                            ...
                                            focusable="false">
                                            <title>Placeholder</title>
                                            <rect width="100%" height="100%" fill="#555" /><text x="50%" y="50%"
                    ...
                    <div>
                        ...
                        <div class="bd-example">
                            <div class="list-group">
                                ...
                                <a href="#"
                                    class="list-group-item list-group-item-action list-group-item-danger">A simple danger
                                    list group item</a>
                                <a href="#"
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                    ...
                                    <p><strong>This is some placeholder content the Home tab's associated content.</strong>
                                        ...
                                        JavaScript swaps classes to control the content visibility and styling. You can use
                                        it with tabs, pills, and any other <code>.nav</code>-powered navigation.</p>
                                </div>
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                <div class="container-fluid">
                                    <a class="navbar-brand" href="#">
                                        <img src="https://getbootstrap.com/docs/5.0/assets/brand/bootstrap-logo-white.svg"
                                            width="38" height="30" class="d-inline-block align-top"
                ...
                <article class="my-3" id="toasts">
                    ...
                    <div>
                        <div class="bd-example bg-dark align-items-center p-5">
                            <div class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                                <div class="toast-header">
                                    <svg class="bd-placeholder-img me-2 rounded" width="20" height="20"
                ...
                <article class="mb-5 mt-3 pb-5" id="tooltips">
