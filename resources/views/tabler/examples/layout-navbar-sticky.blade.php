{{--
    ...
    Same as horizontal layout but navbar is wrapped in sticky-top div.

    Structure:
    - Sticky navbar wrapper: <div class="sticky-top">
    - Top navbar: with sticky-top class
    - Secondary menu + page wrapper

    Body class: None
    Key classes: sticky-top (wrapper and header)
--}}
                            ...
                            <div class="row row-deck row-cards">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p>This is the official Tabler layout with sticky navbar that stays at top
                                                on scroll.</p>
                                            <p>Key features:</p>
                                            <ul>
                                            ...
                                            <p>Try scrolling down to see the sticky navbar in action!</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <p>This is example content to demonstrate the sticky navbar. Scroll down
                                                    to see the navbar stay at the top of the viewport.</p>
                                            </div>
                                        </div>
                                    </div>
                                @endfor
