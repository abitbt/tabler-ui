{{--
    ...
    Same as horizontal layout but with layout-boxed class on body.

    Structure:
    - Same as horizontal layout (navbar + secondary menu + page wrapper)
    - Content is centered with max-width constraint

    Body class: layout-boxed
    Key classes: Same as horizontal layout
--}}
                            ...
                            <div class="row row-deck row-cards">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p>This is the official Tabler boxed layout with centered, max-width
                                                content.</p>
                                            <p>Key features:</p>
                                            <ul>
                                                <li>Same structure as horizontal layout</li>
                                                <li>Body class: <code>layout-boxed</code></li>
                                                <li>Content is centered with max-width constraint</li>
                                                <li>Perfect for focused, document-style interfaces</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
