                        ...
                        <div class="col-md-6">
                            <x-tabler::cards.card>
                                ...
                                <x-tabler::cards.body>
                                    <div class="demo-dropdown-container">
                                        <x-tabler::dropdowns.dropdown>
                                            <x-tabler::dropdowns.toggle href="#" class="nav-link">Profile Menu</x-tabler::dropdowns.toggle>
                            ...
                            <x-tabler::cards.card>
                                ...
                                <x-tabler::cards.body>
                                        ...
                                        <table class="table table-vcenter">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-azure-lt">string|null</span></td>
                                                    <td><code>null</code></td>
                                                    <td>Button color: <code>primary</code>, <code>secondary</code>, <code>success</code>, <code>danger</code>, <code>warning</code>, <code>info</code>, etc.</td>
                                                </tr>
                                                <tr>
                                                    <td><code>icon</code></td>
                                                    <td><span class="badge bg-azure-lt">string|null</span></td>
                                                    <td><code>null</code></td>
                                                    <td>Icon component name (e.g., <code>chevron-down</code>, <code>dots-vertical</code>). Icon appears after toggle text</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                        ...
                                        <table class="table table-vcenter">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge bg-azure-lt">string|null</span></td>
                                                    <td><code>null</code></td>
                                                    <td>Icon component name (e.g., <code>user</code>, <code>settings</code>). Icon appears before item text</td>
                                                </tr>
                                                <tr>
                                    ...
                                    <ul class="text-secondary">
                                        ...
                                        <li>Toggle automatically includes <code>data-bs-toggle="dropdown"</code> and <code>aria-expanded</code> attributes</li>
                                        <li>Disabled items include <code>tabindex="-1"</code> and <code>aria-disabled="true"</code> for accessibility</li>
                                        <li>Use <code>class="dropdown-menu-end"</code> on menu to right-align the dropdown</li>
                                        <li>Use <code>class="btn-icon"</code> on toggle for icon-only buttons (removes text padding)</li>
