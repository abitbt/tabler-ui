                            ...
                            <div class="table-responsive">
                                <table class="table table-vcenter">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-azure-lt">string</span></td>
                                        <td><code>'top'</code></td>
                                        <td>Status bar position. Options: <code>top</code>, <code>start</code>, <code>bottom</code>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><code>color</code></td>
                        ...
                        <x-tabler::cards.body>
                            ...
                            <div class="mt-4">
                                ...
                                <p class="text-secondary">
                                    ...
                                    <code>bg-primary</code>, <code>bg-secondary</code>, <code>bg-success</code>, <code>bg-danger</code>,
