                ...
                <x-tabler::cards.card>
                    <x-tabler::cards.header>
                        <x-tabler::tabs.nav inCard fill>
                            ...
                            <x-tabler::tabs.nav-item href="#tabs-activity-6" icon="activity">Activity</x-tabler::tabs.nav-item>
                        </x-tabler::tabs.nav>
                    </x-tabler::cards.header>
                    <x-tabler::cards.body>
                        <x-tabler::tabs.content>
                    ...
                    <x-tabler::cards.body>
                        ...
                        <div class="mt-4">
                            ...
                            <ul class="text-secondary">
                                ...
                                <li>Each tab nav-item's <code>href</code> must match a pane's <code>id</code> (href includes #, id does not)</li>
                                <li>First tab should have <code>active</code> prop on both nav-item and pane</li>
                                <li>When <code>iconOnly</code> is true, aria-label is automatically generated from icon name for accessibility</li>
                                <li>Use <code>class="ms-auto"</code> on nav-item to push tabs to the right (useful for settings/action tabs)</li>
                                <li>Pills can be combined with <code>inCard</code> to get <code>card-header-pills</code> styling</li>
                ...
                <x-tabler::cards.card>
                    ...
                    <x-tabler::cards.body>
                            ...
                            <table class="table table-vcenter">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Applied automatically when <code>inCard</code> and <code>pills</code> props are true</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <ul class="text-secondary">
                                <li><code>mb-3</code>, <code>mt-3</code> - Margin utilities for spacing around tab container</li>
